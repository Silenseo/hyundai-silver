...
@section('styles')
    <link rel="stylesheet" href="{{ mix('/dealer/css/dealerCars/placeholder.css') }}">
    <link rel="stylesheet" href="{{ mix('/dealer/css/dealerCars/libs.css') }}">
@endsection
...
@section('scripts')
    <script src="{{ mix('/dealer/js/dealerCars/libs.js') }}"></script>
    <script src="{{ mix('/dealer/js/dealerCars/index.js') }}"></script>
@endsection
