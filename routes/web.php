...
Route::get('/promo/halva', function() {
    return view('frontend.promo.halva', ['header' => true, 'highlight' => false, 'footer' => true]);
});
// Katok
...
Route::get('/promo/solaris_super_series_2', function () {
    ...
    */
        ...
        return view('frontend.promo.solaris_super_series_2', ['header' => true, 'highlight' => false, 'footer' => true, 'dealers' => $dealers]);
